<template>
  <div class="min-h-screen bg-neutral-50 dark:bg-neutral-950">
    ...
    <main class="max-w-3xl mx-auto px-4 py-16 flex flex-col items-center gap-4 text-center">
      ...
      <NuxtLink
        to="/dashboard"
        class="mt-2 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors"
